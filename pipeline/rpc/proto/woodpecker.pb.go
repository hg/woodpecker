...
type BatchedLogRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	LogEntry []*LogEntry `protobuf:"bytes,1,rep,name=logEntry,proto3" json:"logEntry,omitempty"`
}

func (x *BatchedLogRequest) Reset() {
	*x = BatchedLogRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchedLogRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchedLogRequest) ProtoMessage() {}

func (x *BatchedLogRequest) ProtoReflect() protoreflect.Message {
	mi := &file_woodpecker_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchedLogRequest.ProtoReflect.Descriptor instead.
func (*BatchedLogRequest) Descriptor() ([]byte, []int) {
	return file_woodpecker_proto_rawDescGZIP(), []int{12}
}

func (x *BatchedLogRequest) GetLogEntry() []*LogEntry {
	if x != nil {
		return x.LogEntry
	}
	return nil
...
var file_woodpecker_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x79, 0x22, 0x40, 0x0a, 0x11, 0x42, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x4c, 0x6f,
	0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x08, 0x6c, 0x6f, 0x67, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x6e, 0x32, 0xf3, 0x04, 0x0a, 0x0a, 0x57, 0x6f, 0x6f, 0x64, 0x70, 0x65, 0x63, 0x6b, 0x65, 0x72,
	...
	0x74, 0x79, 0x22, 0x00, 0x12, 0x36, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x42, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x64, 0x12, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x64, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x70,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x0f, 0x55, 0x6e,
	0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x0c, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0c, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x0c, 0x52,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x32, 0x43, 0x0a, 0x0e, 0x57, 0x6f, 0x6f, 0x64, 0x70,
	0x65, 0x63, 0x6b, 0x65, 0x72, 0x41, 0x75, 0x74, 0x68, 0x12, 0x31, 0x0a, 0x04, 0x41, 0x75, 0x74,
	...
	0x67, 0x6f, 0x2e, 0x77, 0x6f, 0x6f, 0x64, 0x70, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2d, 0x63, 0x69,
	0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x77, 0x6f, 0x6f, 0x64, 0x70, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2f,
	0x76, 0x32, 0x2f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2f, 0x72, 0x70, 0x63, 0x2f,
...
var file_woodpecker_proto_goTypes = []any{
	...
	(*BatchedLogRequest)(nil),     // 12: proto.BatchedLogRequest
...
var file_woodpecker_proto_depIdxs = []int32{
	...
	2,  // 6: proto.BatchedLogRequest.logEntry:type_name -> proto.LogEntry
	4,  // 7: proto.NextResponse.workflow:type_name -> proto.Workflow
	13, // 8: proto.Woodpecker.Version:input_type -> proto.Empty
	5,  // 9: proto.Woodpecker.Next:input_type -> proto.NextRequest
	6,  // 10: proto.Woodpecker.Init:input_type -> proto.InitRequest
	7,  // 11: proto.Woodpecker.Wait:input_type -> proto.WaitRequest
	8,  // 12: proto.Woodpecker.Done:input_type -> proto.DoneRequest
	9,  // 13: proto.Woodpecker.Extend:input_type -> proto.ExtendRequest
	10, // 14: proto.Woodpecker.Update:input_type -> proto.UpdateRequest
	11, // 15: proto.Woodpecker.Log:input_type -> proto.LogRequest
	12, // 16: proto.Woodpecker.LogBatched:input_type -> proto.BatchedLogRequest
	15, // 17: proto.Woodpecker.RegisterAgent:input_type -> proto.RegisterAgentRequest
	13, // 18: proto.Woodpecker.UnregisterAgent:input_type -> proto.Empty
	...
	13, // 28: proto.Woodpecker.Log:output_type -> proto.Empty
	13, // 29: proto.Woodpecker.LogBatched:output_type -> proto.Empty
	18, // 30: proto.Woodpecker.RegisterAgent:output_type -> proto.RegisterAgentResponse
	13, // 31: proto.Woodpecker.UnregisterAgent:output_type -> proto.Empty
	13, // 32: proto.Woodpecker.ReportHealth:output_type -> proto.Empty
	20, // 33: proto.WoodpeckerAuth.Auth:output_type -> proto.AuthResponse
...
func file_woodpecker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_woodpecker_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*BatchedLogRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_woodpecker_proto_msgTypes[20].Exporter = func(v any, i int) any {
