...
const (
	...
	Woodpecker_LogBatched_FullMethodName      = "/proto.Woodpecker/LogBatched"
...
type WoodpeckerClient interface {
	...
	LogBatched(ctx context.Context, in *BatchedLogRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *woodpeckerClient) LogBatched(ctx context.Context, in *BatchedLogRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Woodpecker_LogBatched_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WoodpeckerServer interface {
	...
	LogBatched(context.Context, *BatchedLogRequest) (*Empty, error)
...
func (UnimplementedWoodpeckerServer) LogBatched(context.Context, *BatchedLogRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LogBatched not implemented")
}
...
func _Woodpecker_LogBatched_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchedLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WoodpeckerServer).LogBatched(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Woodpecker_LogBatched_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WoodpeckerServer).LogBatched(ctx, req.(*BatchedLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Woodpecker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LogBatched",
			Handler:    _Woodpecker_LogBatched_Handler,
		},
		{
